...
import 'package:money/pages/create_group/create_group_bloc.dart';
...
class _CreateGroupPageState extends State<CreateGroupPage> {
  CreateGroupBloc bloc = CreateGroupBloc()
    ..add(CreateGroupEventInit());
              ...
              child: ListView(
                ...
                children: [
                  TextFormField(
                    ...
                    controller: nameTEC,
                    onEditingComplete: ()=> FocusScope.of(context).requestFocus(descriptionNode),
                    validator: (text) {
